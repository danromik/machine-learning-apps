...
>
  ...
  <div class="flex items-center gap-2 min-w-0">
    <Icon name="cube" size={20} strokeWidth={1} class="text-[var(--color-accent)] shrink-0" />
    <span class="text-sm font-semibold tracking-tight truncate">Agentic Cube Trainer</span>
  </div>
  ...
  <div class="flex items-center gap-2">
    ...
    <button
      type="button"
      onclick={toggleChat}
      title={chat.visible ? 'Hide RL Coach chat' : 'Show RL Coach chat'}
